...
myApp.factory('Enum', function () {
    ...
    return {
        ...
        Url: {
            ...
            PrintAgreement: "AgreementData/PrintAgreementPdf?clientId=@&AgreementID=@&status=@",
...
document.addEventListener("offline", function () {
    ...
    //    message: 'No internet connectivity detected. Please reconnect and try again.', title: 'No internet connection', animation: 'slide', buttonLabel: 'Ok' /*, callback: function () {
